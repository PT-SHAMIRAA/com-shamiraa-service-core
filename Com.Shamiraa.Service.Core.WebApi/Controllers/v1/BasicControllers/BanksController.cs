...
namespace Com.Shamiraa.Service.Core.WebApi.Controllers.v1.BasicControllers
{
    ...
    public class BanksController : BasicController<BankService, Bank, BankViewModel, CoreDbContext>
    {
        private new static readonly string ApiVersion = "1.0";

        public BanksController(BankService service) : base(service, ApiVersion)
        {
        }
    }
}