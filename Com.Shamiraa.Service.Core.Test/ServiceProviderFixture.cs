        ...
        public ServiceProviderFixture()
        {
            IConfigurationRoot configuration = new ConfigurationBuilder()
                .AddInMemoryCollection(new List<KeyValuePair<string, string>>
                {
                    ...
                    new KeyValuePair<string, string>("DefaultConnection",  "Server=localhost,1401; Database = com.Shamiraa.db.core.service.test; User = sa; password = Standar123.; MultipleActiveResultSets = true; ")
