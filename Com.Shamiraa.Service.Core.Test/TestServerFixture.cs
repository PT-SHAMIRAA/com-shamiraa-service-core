...
using Com.Shamiraa.Service.Core.WebApi;
...
namespace Com.Shamiraa.Service.Core.Test
{
            ...
            */
            ...
            IConfigurationRoot configuration = new ConfigurationBuilder()
                .AddInMemoryCollection(new List<KeyValuePair<string, string>>
                {
                    ...
                    */
                    new KeyValuePair<string, string>("Secret", "ShamiraaTESTENVIRONMENT"),
					new KeyValuePair<string, string>("ASPNETCORE_ENVIRONMENT", "Test"),
                    new KeyValuePair<string, string>("DefaultConnection", "Server=localhost,1401;Database=com.Shamiraa.db.core.controller.test;User=sa;password=Standar123.;MultipleActiveResultSets=true;")
                    //new KeyValuePair<string, string>("DefaultConnection", "Server=(localdb)\\mssqllocaldb;Database=com-Shamiraa-db-test;Trusted_Connection=True;MultipleActiveResultSets=true"),
