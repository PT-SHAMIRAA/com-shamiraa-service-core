...
using Com.Shamiraa.Service.Core.WebApi.Controllers.v1.BasicControllers;
...
namespace Com.Shamiraa.Service.Core.Test.Controllers.MasterExpedition
{
    public class BasicTests
    {
        ...
        public Com.Shamiraa.Service.Core.Lib.Models.MasterExpedition GetTestData(CoreDbContext dbContext)
        {
            Com.Shamiraa.Service.Core.Lib.Models.MasterExpedition data = new Com.Shamiraa.Service.Core.Lib.Models.MasterExpedition();
        ...
        public void Get_Return_OK()
        {
            ...
            Com.Shamiraa.Service.Core.Lib.Models.MasterExpedition testData = GetTestData(dbContext);
        ...
        public void POST_BadRequest()
        {
            ...
            validateServiceMock.Setup(v => v.Validate(It.IsAny<Com.Shamiraa.Service.Core.Lib.Models.MasterExpedition>())).Verifiable();
